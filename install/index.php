...
if (isset($_POST['lng']) && ($_POST['lng'] == 'ru' || $_POST['lng'] == 'vn')) {
    $_SESSION['language'] = $_POST['lng'];
}

$language = isset($_SESSION['language']) ? $_SESSION['language'] : 'vn';
...
if (!$act) {
    echo '<form action="index.php" method="post">' .
        ...
        '<div><input type="radio" name="lng" value="vn" ' . ($language == 'vn' ? 'checked="checked"' : '') . ' />&#160;English</div>' .
