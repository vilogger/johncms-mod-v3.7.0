...
class KCAPTCHA {
    ...
    function KCAPTCHA() {
        ...
        $pixel_color = @imagecolorallocatealpha($img2, 60, 75, 114, 100);
        for ($i = 0; $i < 1000; $i++)
        {
            @imagesetpixel($img2, rand() % $width, rand() % $height, $pixel_color);
        }
        ...
        $radius = 50;
            ...
            foreach ($positions as $pos) {
                imageCopyResampled($corner, $img2, $pos[0], $pos[1], $pos[2], $pos[3], $rs_radius, $rs_radius, $radius, $radius);
            }
            ...
            foreach ($positions as $i => $pos) {
                imageCopyResampled($img2, $corner, $pos[2], $pos[3], $pos[0], $pos[1], $radius, $radius, $rs_radius, $rs_radius);
            }
        ob_start();
