...
if (core::$user_rights >= 7) {
    ...
    echo '<div class="phdr"><a href="/forum/' . $id . '/'.$topic['seo'].'_start' . $start . '.html"><b>' . $lng['forum'] . '</b></a> | ' . $lng_forum['curators'] . '</div>' .
    ...
    echo '<div class="phdr">' . $lng['total'] . ': ' . $total . '</div>' .
         '<p><a href="/forum/' . $id . '/'.$topic['seo'].'_start' . $start . '.html">' . $lng['back'] . '</a></p>';
}