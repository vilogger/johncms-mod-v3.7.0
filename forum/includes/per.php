...
if ($rights == 3 || $rights >= 6) {
    ...
    if (isset($_POST['submit'])) {
        ...
        */
        ...
        echo '<div class="phdr"><a href="/forum/' . $id . '/' . $ms['seo'] . '.html"><b>' . $lng['forum'] . '</b></a> | ' . $lng_forum['topic_move'] . '</div>' .
            '<form action="index.php?act=per&amp;id=' . $id . '" method="post">' .
            '<div class="gmenu"><p>' .
            '<h3>' . $lng['category'] . '</h3><br />' . $fr1['text'] . '</p>' .
        ...
        echo '<div class="phdr"><a href="index.html">' . $lng['back'] . '</a></div>';
    }
}
