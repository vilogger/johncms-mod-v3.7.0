...
if ($rights == 3 || $rights >= 6) {
    ...
    if (isset($_GET['delvote']) && !empty($_GET['vote'])) {
        ...
        echo '<div class="gmenu"><p>' . $lng_forum['voting_changed'] . '<br /><a href="/forum/' . $id . '/' . $seof1['seo'] . '.html">' . $lng['continue'] . '</a></p></div>';
    } else {
        /*
        -----------------------------------------------------------------
        ...
        */
        ...
        echo '<div class="phdr"><a href="/forum/' . $id . '/' . $seof1['seo'] . '.html"><b>' . $lng['forum'] . '</b></a> | ' . $lng_forum['edit_vote'] . '</div>' .
        ...
        echo '</p></div><div class="gmenu">' .
            ...
            '</div></form>' .
            '<div class="phdr"><a href="/forum/' . $id . '/' . $seof1['seo'] . '.html">' . $lng['cancel'] . '</a></div>';
    }
}
