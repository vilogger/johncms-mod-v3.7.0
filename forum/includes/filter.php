...
if (!$id) {
    echo functions::display_error($lng['error_wrong_data'], '<a href="index.html">' . $lng['to_forum'] . '</a>');
...
switch ($do) {
    case 'unset':
        ...
        */
        ...
        header('Location: /forum/'.$id.'/'.$seof1['seo'].'.html');
        break;
    ...
    default :
        ...
        */
        ...
        if ($total > 0) {
            echo '<div class="phdr"><a href="/forum/' . $id . '/'.$seof1['seo'].'_start' . $start . '.html"><b>' . $lng['forum'] . '</b></a> | ' . $lng_forum['filter_on_author'] . '</div>' .
...
echo '<p><a href="/forum/' . $id . '/'.$seof1['seo'].'_start' . $start . '.html">' . $lng_forum['return_to_topic'] . '</a></p>';