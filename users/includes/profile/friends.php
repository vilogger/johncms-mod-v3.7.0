...
`user_id`='$id', `from_id`='$user_id', `time`='" . time() . "'");
                    ...
                    $text = '[url=' . core::$system_set['homeurl'] . '/users/profile.php?user=' . $user_id . '][cnick]' . $user_id . '[/cnick][/url] ' . $lng_tmp['offers_friends'] . ' [url=' . core::$system_set['homeurl'] . '/users/profile.php?act=friends&do=ok&id=' . $user_id . ']' . $lng_tmp['confirm'] . '[/url] | [url=' . $home . '/users/profile.php?act=friends&do=no&id=' . $user_id . ']' . $lng_tmp['decline'] . '[/url]';
...
`them` = '26'");
                    ...
                    if ($friends) {
                        $text1 = '[url=' . core::$system_set['homeurl'] . '/users/profile.php?user=' . $user_id . '][cnick]' . $user_id . '[/cnick][/url] ' . $arr_fr[$friends] . ' [url=' . core::$system_set['homeurl'] . '/users/profile.php?act=friends&do=okfriends&id=' . $user_id . ']' . $lng_profile['confirm'] . '[/url]';
                        mysql_query("INSERT INTO `cms_mail` SET
`user_id` = '$user_id', 
`from_id` = '$id',
`text` = '$text1',
...
");
                    ...
                    $text = '[url=' . core::$system_set['homeurl'] . '/users/profile.php?user=' . $user_id . '][cnick]' . $user_id . '[/cnick][/url] ' . $lng_profile['offers_friends'] . ' [url=' . core::$system_set['homeurl'] . '/users/profile.php?act=friends&do=ok&id=' . $user_id . ']' . $lng_profile['confirm'] . '[/url] | [url=' . $home . '/users/profile.php?act=friends&do=no&id=' . $user_id . ']' . $lng_profile['decline'] . '[/url]';
            ...
            if ($set_mail['cat_friends']) {
                ...
                if ($fr) {
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        $text = '[url=' . core::$system_set['homeurl'] . '/users/profile.php?user=' . $id . '][cnick]' . $id . '[/cnick][/url] ' . $arr_fr[$res['man']] . ' [url=' . core::$system_set['homeurl'] . '/users/profile.php?act=friends&do=okfriends&id=' . $id . ']' . $lng_profile['confirm'] . '[/url]';
...
");
                    ...
                    $text = '[url=' . core::$system_set['homeurl'] . '/users/profile.php?user=' . $user_id . '][cnick]' . $user_id . '[/cnick][/url] ' . $lng_profile['complied_friends'];
                    mysql_query("INSERT INTO `cms_mail` SET
    `user_id` = '$user_id',
    `from_id` = '$id',
...
");
                    ...
                    $text = '[url=' . core::$system_set['homeurl'] . '/users/profile.php?user=' . $id . '][cnick]' . $id . '[/cnick][/url] ' . $lng_profile['offers_friends'] . ' [url=' . core::$system_set['homeurl'] . '/users/profile.php?act=friends&do=ok&id=' . $id . ']' . $lng_profile['confirm'] . '[/url] | [url=' . core::$system_set['homeurl'] . '/users/profile.php?act=friends&do=no&id=' . $id . ']' . $lng_profile['decline'] . '[/url]';
                    mysql_query("DELETE FROM `cms_mail` WHERE `user_id` = '$id' AND `from_id` = '$user_id' AND `text`='" . mysql_real_escape_string($text) . "'");
...
");
                    ...
                    $text = '[url=' . core::$system_set['homeurl'] . '/users/profile.php?user=' . $user_id . '][cnick]' . $user_id . '[/cnick][/url] ' . $lng_profile['deleted_you_friends'];
                    mysql_query("INSERT INTO `cms_mail` SET
    `user_id` = '$user_id',
    `from_id` = '$id',
    `text` = '" . mysql_real_escape_string($text) . "',
        ...
        case 'no':
            ...
            if ($fr != 2) {
                if (isset($_POST['submit'])) {
                    ...
                    $text = '[url=' . core::$system_set['homeurl'] . '/users/profile.php?user=' . $user_id . '][cnick]' . $user_id . '[/cnick][/url] ' . $lng_profile['canceled_you_demand'];
                    mysql_query("INSERT INTO `cms_mail` SET
    `user_id` = '$user_id',
    `from_id` = '$id',
    `text` = '" . mysql_real_escape_string($text) . "',
...
<input type="submit" value="' . $lng['to_page'] . ' &gt;&gt;"/></form></p>';
            ...
            case 'offers':
                echo '<div class="phdr"><b>' . $lng_profile['friends'] . '</b></div>';
                echo '<div class="topmenu"><a href="profile.php?act=friends">' . $lng_profile['my_friends'] . '</a> | <a href="profile.php?act=friends&amp;do=demands">' . $lng_profile['my_demand'] . '</a> ' . ($dem ? '(<span class="red">' . $dem . '</span>)' : '') . '| <b>' . $lng_profile['my_offers'] . '' . ($off ? ' (<span class="red">' . $off . '</span>)' : '') . '</b></div>';
    ...
    "), 0);
        ...
        LIMIT " . $start . "," . $kmess
                    ...
                    for ($i = 0; ($row = mysql_fetch_assoc($req)) !== FALSE; ++$i) {
                        ...
                        $arg = array(
                            'header' => 'Tổng: ' . $count_message . ' tin nhắn' . ($new_count_message ? ', trong đó có ' . $new_count_message . ' chưa đọc.' : ''),
                            'sub'    => $subtext
                        );
                        echo functions::display_user($row, $arg);
                        echo '</div>';
        ...
        echo '<p><a href="profile.php">' . $lng['personal'] . '</a></p>';
    }
}