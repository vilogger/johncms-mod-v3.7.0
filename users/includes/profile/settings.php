    ...
    case 'forum':
        ...
        */
        ...
        echo '<form action="profile.php?act=settings&amp;mod=forum" method="post">' .
            '<div class="menu"><p><h3>' . $lng_set['main_settings'] . '</h3><br />' .
            ...
            '</p><p><h3>' . $lng_set['clip_first_post'] . '</h3><br />' .
    ...
    default:
        ...
        */
        ...
        echo '<form action="profile.php?act=settings" method="post" >' .
            '<div class="menu"><p><h3>' . $lng['settings_clock'] . '</h3><br />' .
            ...
            '</p><p><h3>' . $lng['system_functions'] . '</h3><br />' .
        ...
        if (count(core::$lng_list) > 1) {
            echo '<p><h3>' . $lng['language_select'] . '</h3><br />';
