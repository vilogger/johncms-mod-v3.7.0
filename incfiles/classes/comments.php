...
class comments
{
                ...
                */
                ...
                if ($this->total) {
                    ...
                    while (($res = mysql_fetch_assoc($req)) !== false) {
                        ...
                        $user_arg = array(
                            'header' => '<div align="right" style="font-size: x-small;"><span class="gray">(' . functions::display_date($res['time']) . ')</span></div>',
                            'body' => $text,
    ...
    */
    ...
    {
        return '<div class="gmenu"><div class="story-publisher-box"><form name="form" action="' . $this->url . $submit_link . '" method="post"><p>' .
               ...
               '<input type="hidden" name="code" value="' . rand(1000, 9999) . '" /><input type="submit" name="submit" value="' . core::$lng['sent'] . '"/></p></form></div></div>';
    }
