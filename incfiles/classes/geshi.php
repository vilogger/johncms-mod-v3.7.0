...
class GeSHi {
     ...
     * @var string
     */
    var $overall_style = 'font-family: \'Helvetica Neue\', Helvetica, \'Droid Sans\', \'DroidSansRegular\', Arial, sans-serif;';

    /**
     *  The style for the actual code
     * @var string
     */
    var $code_style = 'font-family: \'Helvetica Neue\', Helvetica, \'Droid Sans\', \'DroidSansRegular\', Arial, sans-serif; font-size: small; margin:0; padding:0; background:none; vertical-align:top;';
