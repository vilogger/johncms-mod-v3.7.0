...
// Общие настройки
echo '<p>' .
    '<h3>' . $lng['common_settings'] . '</h3><br />' .
    $lng['site_url'] . ':<br/>' . '<input type="text" name="homeurl" value="' . htmlentities($set['homeurl']) . '"/><br/>' .
    $lng['site_copyright'] . ':<br/>' . '<input type="text" name="copyright" value="' . addslashes($set['copyright']) . '"/><br/>' .
    $lng['site_email'] . ':<br/>' . '<input type="text" name="madm" maxlength="50" value="' . htmlentities($set['email']) . '"/><br />' .
...
echo '<p><h3>' . $lng['design_template'] . '</h3><br />&#160;<select name="skindef">';
$dir = opendir('../theme');
