        ...
        */
        ...
        if (isset($_POST['submit'])) {
            ...
            echo '<form action="index.php?act=ads&amp;mod=edit' . ($id ? '&amp;id=' . $id : '') . '" method="post">' .
                 '<div class="menu"><p><h3>' . $lng['link'] . '</h3><br />' .
                 ...
                 '<p><h3>' . $lng['links_allocation'] . '</h3><br />' .
